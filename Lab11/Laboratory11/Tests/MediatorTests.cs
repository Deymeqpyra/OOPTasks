...
public class MediatorTests
{
    ...
    public MediatorTests()
    {
        var serviceProvider = new ServiceCollection()
            ...
            .AddTransient<IRequestHandler<Message, NotificationResult>, MessageHandler>()
    ...
    public async Task Publish_should_return_error_when_handler_throws_exception()
    {
        ...
        var serviceProvider = new ServiceCollection()
            .AddTransient<IRequestHandler<Message, NotificationResult>>(sp =>
            {
    ...
    public async Task Send_should_return_error_when_handler_not_found()
    {
        ...
        await act.Should().ThrowAsync<InvalidOperationException>()
            .WithMessage("Handler for SampleRequest not found.");
    }
    ...
    public class CustomErrorHandler : IRequestHandler<Message, NotificationResult>
    {
        public Task<NotificationResult> Handle(Message message)
        {
